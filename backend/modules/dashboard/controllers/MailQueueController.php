...
use backend\modules\dashboard\models\search\SearchMailQueue;
...
class MailQueueController extends Controller
{
    ...
    {
        $searchModel = new SearchMailQueue();
    ...
    /**
     * Displays a single MailQueue model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Updates an existing MailQueue model.
